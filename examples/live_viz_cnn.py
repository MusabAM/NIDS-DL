"""
Example: Run live Hilbert map with CNN model on NSL-KDD test data
"""
...
if not Path(MODEL_PATH).exists():
    ...
    print(
        "Please train the CNN model first using notebooks/02_classical_dl/01_cnn_nsl_kdd.ipynb"
    )
    exit(1)
...
print("🚀 Starting live visualization with CNN model...")
print("=" * 60)
