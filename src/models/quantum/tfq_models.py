...
def create_tfq_model(
    n_qubits: int = 8, n_layers: int = 3, num_classes: int = 2, **kwargs
) -> TFQClassifier:
    """
    ...
    return TFQClassifier(
        n_qubits=n_qubits, n_layers=n_layers, num_classes=num_classes, **kwargs
    )
...
def create_hybrid_tfq_model(
    ...
    var_circuit, var_symbols = create_variational_circuit(qubits, n_quantum_layers)
