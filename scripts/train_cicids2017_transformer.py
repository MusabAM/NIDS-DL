"""
Train a Transformer classifier on the CICIDS2017 dataset.
Uses the improved Transformer model from src/models/classical/transformer.py.
"""
...
MODEL_SAVE_PATH = os.path.join(MODELS_DIR, "best_transformer_cicids2017.pth")
RESULTS_PATH = os.path.join(RESULTS_DIR, "transformer_cicids2017_results.txt")
...
def main():
    ...
    num_classes = 2
    model = create_transformer(input_dim, num_classes).to(DEVICE)
    ...
    with open(RESULTS_PATH, "w") as f:
        f.write(f"Transformer CICIDS2017 Results\n{'='*50}\n")
